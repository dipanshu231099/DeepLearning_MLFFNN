    ...
    def learn(self):
        ...
        for i in range(MAX_EPOCHS):
            ...
            for n in range(len(self.train)):
                ...
                s = self.activation(a)
                inst_error = 0.5 *( (s-self.actual[n])**2)
...
def main():
    filename = "UnivariateData/2.csv"
    graphs_dir = "graphs_univariate_perceptron/"
    ...
    plt.scatter(train_data[0], train_predictions, label="Predicted Values")
    plt.scatter(train_data[0], train_data[1], label="Actual Values")
    plt.legend()
    ...
    plt.scatter(val_data[0], val_predictions, label="Predicted Values")
    plt.scatter(val_data[0], val_data[1], label="Actual Values")
    plt.legend()
    ...
    plt.scatter(test_data[0], test_predictions, label="Predicted Values")
    plt.scatter(test_data[0], test_data[1], label="Actual Values")
    plt.legend()
