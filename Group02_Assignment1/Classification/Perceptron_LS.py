...
class Perceptron:
    ...
    def learn(self):
        MAX_EPOCHS = 1000 # Just to avoid computer hangs in case computations go out of bounds
...
print(calculate_accuracy(total_test_true , model.predict(total_test)))
