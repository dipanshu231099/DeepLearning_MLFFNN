...
graphs_dir = 'graphs_univariate_MLFFN/'
...
class Neural_Network():
    ...
    def node_wise_graph(self, node, layer, e):
        ...
        plt.scatter(self.train_x, outcomes, label=label)
        plt.legend()
    ...
    def validation_prediction_graph(self):
        val_pred = self.predict(self.val_x)
        plt.scatter(self.val_x, self.val_y, label="actual")
        plt.scatter(self.val_x, val_pred, label="predictions")
        plt.legend()
    ...
    def test_prediction_graph(self):
        ...
        plt.scatter(self.test_x, self.test_y, label="actual")
        plt.scatter(self.test_x, test_pred, label="predictions")
        plt.legend()
...
def main():
    data = get_data('UnivariateData/2.csv')
    # normalise
    ...
    model.validation_prediction_graph()
